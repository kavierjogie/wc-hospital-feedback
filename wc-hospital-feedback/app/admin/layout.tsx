...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  try {
    ...
    // If it is a Next.js redirect error or dynamic server usage error, we MUST rethrow it so Next.js handles it.
    if (
    ...
    console.error('[Admin Layout] Server-side exception caught:', error)
    redirect('/login')
  }
}
